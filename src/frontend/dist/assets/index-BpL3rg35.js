...
const CA$5 = "3AmTiVi5L4rDuf1CCQLkx8kBEZ52N6Mr7DrZwfDYjizz";
const year = (/* @__PURE__ */ new Date()).getFullYear();
function Footer() {
  const [copied, setCopied] = reactExports.useState(false);
  function handleCopy() {
    navigator.clipboard.writeText(CA$5).then(() => {
      setCopied(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-black text-uppercase-tight neon-green tracking-widest", children: "$PIGEON NEST" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 font-mono mt-1 text-uppercase-tight", children: "THE PIGEON HAS LANDED ON SOLANA" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: CA$5 }),
              copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, className: "shrink-0 neon-green" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12, className: "shrink-0" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", "data-ocid": "footer.socials", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SiTelegram, { size: 14 }),
                "TELEGRAM"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 14 }),
                "X / TWITTER"
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-foreground/30 max-w-2xl leading-relaxed", children: "$PIGEON is a meme coin with no intrinsic value or financial return expectation. Nothing on this website constitutes financial advice. Crypto trading involves significant risk. Do your own research." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-xs text-foreground/25", children: [
          "© ",
          year,
          ".",
          " ",
...
const CA$4 = "3AmTiVi5L4rDuf1CCQLkx8kBEZ52N6Mr7DrZwfDYjizz";
const SHORT_CA = `${CA$4.slice(0, 6)}...${CA$4.slice(-4)}`;
const NAV_LINKS = [
...
function NavBar() {
  ...
  const [copied, setCopied] = reactExports.useState(false);
  function handleCopy() {
    navigator.clipboard.writeText(CA$4).then(() => {
      setCopied(true);
      setTimeout(() => setCopied(false), 2e3);
    });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      "data-ocid": "navbar",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-display font-black text-uppercase-tight neon-green tracking-wide", children: "$PIGEON" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-xs font-display text-foreground/50 text-uppercase-tight font-bold", children: "NEST" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/50 font-mono text-xs", children: SHORT_CA }),
                copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, className: "neon-green" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const CA$3 = "3AmTiVi5L4rDuf1CCQLkx8kBEZ52N6Mr7DrZwfDYjizz";
const DEX_API = `https://api.dexscreener.com/latest/dex/tokens/${CA$3}`;
function useDexScreener() {
  return useQuery({
    queryKey: ["dexscreener", CA$3],
    queryFn: async () => {
      ...
      const best = pairs.reduce(
        (a, b) => {
          var _a2, _b2;
          return (((_a2 = b.liquidity) == null ? void 0 : _a2.usd) ?? 0) > (((_b2 = a.liquidity) == null ? void 0 : _b2.usd) ?? 0) ? b : a;
        }
      );
      return best;
    },
...
function formatPrice(price) {
  ...
  if (num < 1e-4) return `$${num.toExponential(4)}`;
...
function PriceTicker() {
  ...
  const price = (data == null ? void 0 : data.priceUsd) ? formatPrice(data.priceUsd) : "$---";
  const change24h = ((_a2 = data == null ? void 0 : data.priceChange) == null ? void 0 : _a2.h24) ?? 0;
  const isPositive = change24h >= 0;
  const changeStr = `${isPositive ? "+" : ""}${change24h.toFixed(2)}%`;
  const tickerLabels = ["a", "b", "c", "d", "e", "f", "g", "h"];
  const tickerContent = tickerLabels.slice(0, TICKER_ITEMS).map((id) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-3 mx-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-uppercase-tight font-mono text-xs font-bold text-foreground/60", children: "$PIGEON" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: { width: "200%" },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex shrink-0", children: tickerContent }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex shrink-0", "aria-hidden": "true", children: tickerContent })
          ]
        }
      )
    }
...
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed top-0 left-0 right-0 z-50 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavBar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PriceTicker, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pt-[92px]", children }),
...
const COMMUNITY_CARDS = [
  {
    ...
    icon: SiTelegram,
    title: "TELEGRAM",
    description: "Join the nest on Telegram. Live alpha, degen talk, and the most based pigeon community in crypto.",
    href: "https://t.me/tehpegionnest",
    cta: "JOIN NEST",
    accent: "green"
  },
  {
    ...
    icon: SiX,
    title: "X / TWITTER",
    description: "Follow the flock on X. Memes, updates, community posts, and pure pigeon energy 24/7.",
    href: "https://x.com/i/communities/1951776220376400069",
    cta: "FOLLOW US",
    accent: "cyan"
  }
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-cyan text-uppercase-tight tracking-widest mb-3", children: "JOIN THE FLOCK" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground", children: "COMMUNITY" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-foreground/50 max-w-md mx-auto", children: "The $PIGEON Nest is powered by the most degenerate, based, and beautiful community on Solana." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-12 rounded overflow-hidden border border-primary/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(to right, oklch(var(--background) / 0.8) 0%, oklch(var(--background) / 0.2) 50%, oklch(var(--background) / 0.8) 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl font-display font-black neon-green text-uppercase-tight drop-shadow-lg", children: "THE FLOCK" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-display font-bold text-foreground/70 text-uppercase-tight mt-1", children: "IS ASSEMBLED" })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: COMMUNITY_CARDS.map((card, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  style: {
                    borderColor: isCyan ? "oklch(var(--accent) / 0.3)" : "oklch(var(--primary) / 0.3)"
                  },
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-uppercase-tight text-foreground mb-1", children: card.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/60 leading-relaxed", children: card.description })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
...
const CA$2 = "3AmTiVi5L4rDuf1CCQLkx8kBEZ52N6Mr7DrZwfDYjizz";
const DEX_PAIR = "https://dexscreener.com/solana/3AmTiVi5L4rDuf1CCQLkx8kBEZ52N6Mr7DrZwfDYjizz";
function DexChartSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "dex-chart",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-cyan text-uppercase-tight tracking-widest mb-3", children: "REAL-TIME CHART" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground", children: [
            "DEX ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "neon-green", children: "SCREENER" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "iframe",
              {
                ...
                src: `https://dexscreener.com/solana/${CA$2}?embed=1&theme=dark&trades=0&info=0`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: "VIEW FULL CHART ON DEXSCREENER →"
          }
        ) })
      ] })
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-green text-uppercase-tight tracking-widest mb-3", children: "GOT QUESTIONS?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground", children: "FAQs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-24 h-1 mx-auto mt-4",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", "data-ocid": "faqs.list", children: FAQS.map((faq, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "border rounded bg-card overflow-hidden",
            style: {
              borderColor: openIndex === idx ? "oklch(var(--primary) / 0.5)" : "oklch(var(--border))"
            },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground text-sm sm:text-base", children: faq.q }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ChevronDown,
                      {
                        size: 18,
              ...
              openIndex === idx && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 text-sm text-foreground/60 leading-relaxed border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children: faq.a }) })
            ]
          },
          faq.q
        )) })
...
function GallerySection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-green text-uppercase-tight tracking-widest mb-3", children: "PIGEON PROPAGANDA" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground", children: [
            "MEME ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "neon-green", children: "GALLERY" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: MEMES.map((meme, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-square", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/0 group-hover:bg-background/20 transition-smooth" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 flex items-center justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-bold text-foreground/80 truncate", children: meme.caption }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
...
const CA$1 = "3AmTiVi5L4rDuf1CCQLkx8kBEZ52N6Mr7DrZwfDYjizz";
function HeroSection() {
  var _a2, _b2;
  const { data, isLoading } = useDexScreener();
  const [copied, setCopied] = reactExports.useState(false);
  function handleCopy() {
    navigator.clipboard.writeText(CA$1).then(() => {
      setCopied(true);
      setTimeout(() => setCopied(false), 2e3);
    });
  }
  const price = (data == null ? void 0 : data.priceUsd) ? formatPrice(data.priceUsd) : "$---";
  const change = ((_a2 = data == null ? void 0 : data.priceChange) == null ? void 0 : _a2.h24) ?? 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 py-16 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 border border-primary/40 rounded w-fit", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/60 text-uppercase-tight", children: "LIVE ON SOLANA" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black leading-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-5xl sm:text-6xl lg:text-7xl neon-green text-uppercase-tight", children: "$PIGEON" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-4xl sm:text-5xl lg:text-6xl text-foreground text-uppercase-tight", children: "NEST" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xl sm:text-2xl font-bold text-foreground/50 mt-2 tracking-widest", children: "IS HERE" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-foreground/60 max-w-md leading-relaxed", children: "The most based pigeon meme coin on Solana. The flock has landed. Get ready to COO your way to the moon. 🐦" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border border-primary/40 rounded bg-primary/5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-1", children: "PRICE" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "text-2xl font-mono font-bold neon-green",
                    "data-ocid": "hero.price",
                    children: isLoading ? "..." : price
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-1", children: "24H" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `text-2xl font-mono font-bold ${isPositive ? "text-green-400" : "text-red-400"}`,
                        "data-ocid": "hero.change_24h",
                        children: isLoading ? "..." : `${isPositive ? "+" : ""}${change.toFixed(2)}%`
                      }
                    )
                  ]
                }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => {
                    var _a3;
                    return (_a3 = document.getElementById("how-to-buy")) == null ? void 0 : _a3.scrollIntoView({ behavior: "smooth" });
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground/30 font-mono", children: "CA:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate max-w-[200px] sm:max-w-none", children: CA$1 }),
                    copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, className: "neon-green shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12, className: "shrink-0" })
                  ]
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-sm lg:max-w-md", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-4 right-4 bg-card/90 backdrop-blur-sm border border-primary/30 rounded p-3 grid grid-cols-3 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight", children: "MCap" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono font-bold neon-green", children: isLoading ? "..." : formatLargeNum(data == null ? void 0 : data.marketCap) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight", children: "VOL 24H" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono font-bold neon-cyan", children: isLoading ? "..." : formatLargeNum((_b2 = data == null ? void 0 : data.volume) == null ? void 0 : _b2.h24) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight", children: "FDV" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono font-bold text-foreground/70", children: isLoading ? "..." : formatLargeNum(data == null ? void 0 : data.fdv) })
              ] })
            ] })
          ] }) })
        ] }) })
...
const STEPS = [
  {
    number: "01",
    title: "GET A WALLET",
    description: "Download Phantom or Solflare wallet. Create your Solana wallet and secure your seed phrase somewhere safe — not your notes app."
  },
  {
    number: "02",
    title: "FUND WITH SOL",
    description: "Buy SOL on any exchange (Binance, Coinbase, Kraken). Send it to your Phantom wallet address. You need SOL for gas fees + the swap."
  },
  {
    number: "03",
    title: "BUY $PIGEON",
    description: "Use the Jupiter swap below or go to Jupiter.ag. Paste the CA, set slippage to 5-10%, and execute your swap. Welcome to the nest."
  }
];
function HowToBuySection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-green text-uppercase-tight tracking-widest mb-3", children: "GET IN THE NEST" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground", children: [
            "HOW TO ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "neon-green", children: "BUY" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: STEPS.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl font-display font-black neon-green opacity-20 mb-3", children: step.number }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-display font-black text-uppercase-tight text-foreground mb-3", children: step.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/60 leading-relaxed", children: step.description })
                ]
              },
              step.number
            ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-3", children: "CONTRACT ADDRESS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-sm sm:text-base font-bold neon-green break-all", children: CA }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/30 font-mono mt-2 text-uppercase-tight", children: "⚠️ ALWAYS VERIFY THE CONTRACT ADDRESS BEFORE BUYING" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12", id: "swap", "data-ocid": "how_to_buy.swap_section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-cyan text-uppercase-tight tracking-widest mb-2", children: "SWAP RIGHT HERE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-display font-black text-uppercase-tight text-foreground", children: "JUPITER SWAP" })
          ] }),
...
function LoreSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-2 lg:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 lg:order-2 flex flex-col gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-cyan text-uppercase-tight tracking-widest mb-3", children: "THE ORIGIN STORY" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground leading-tight", children: [
              "LORE OF THE ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "neon-green", children: "PIGEON" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-foreground/70 leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "In the neon-drenched alleys of Crypto City, where digital dreams take flight and rug pulls lurk in every shadow, one bird rose above the chaos. Not an eagle. Not a hawk. A pigeon." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Born from the streets, hardened by the bear markets, and fueled by nothing but pure degeneracy,",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "neon-green font-bold", children: " $PIGEON" }),
              " emerged from a Solana dumpster dive on a cold winter night. The CTO (Chief Territorial Officer) gathered the flock on Telegram and declared:",
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground/90 italic", children: [
                " ",
                '"We are not rats. We are pigeons. And we COO."'
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The airdropper took to the skies, dropping bags on every based degen who believed. The nest was built not on VCs or influencer deals — but on raw meme energy, community conviction, and absolutely unhinged tokenomics." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-uppercase-tight text-foreground/90 tracking-wide", children: "The pigeons are here. The nest is live. The COO echoes across Solana." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-primary/30 rounded bg-primary/5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-1", children: "CHAIN" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-uppercase-tight neon-green", children: "SOLANA" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-accent/30 rounded bg-accent/5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-1", children: "TYPE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-uppercase-tight neon-cyan", children: "MEME COIN" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-border rounded col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-1", children: "ORIGIN" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-uppercase-tight text-foreground/70", children: "COMMUNITY CTO DROP" })
            ] })
          ] })
        ] })
      ] }) })
...
function StatCard({ label, value, accent = "default" }) {
  const colorClass = accent === "green" ? "neon-green" : accent === "cyan" ? "neon-cyan" : "text-foreground";
  const borderClass = accent === "green" ? "border-primary/40 bg-primary/5" : accent === "cyan" ? "border-accent/40 bg-accent/5" : "border-border bg-card";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-5 border rounded ${borderClass}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-2", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function TokenomicsSection() {
  ...
  const stats = [
    {
      label: "PRICE",
      value: isLoading ? "..." : formatPrice(data == null ? void 0 : data.priceUsd),
      accent: "green"
    },
    {
      label: "MARKET CAP",
      value: isLoading ? "..." : formatLargeNum(data == null ? void 0 : data.marketCap),
      accent: "cyan"
    },
    {
      label: "FDV",
      value: isLoading ? "..." : formatLargeNum(data == null ? void 0 : data.fdv),
      accent: "default"
    },
    {
      label: "24H VOLUME",
      value: isLoading ? "..." : formatLargeNum((_a2 = data == null ? void 0 : data.volume) == null ? void 0 : _a2.h24),
      accent: "default"
    },
    {
      label: "LIQUIDITY",
      value: isLoading ? "..." : formatLargeNum((_b2 = data == null ? void 0 : data.liquidity) == null ? void 0 : _b2.usd),
      accent: "green"
    },
    {
      label: "24H BUYS/SELLS",
      value: isLoading ? "..." : `${((_d2 = (_c2 = data == null ? void 0 : data.txns) == null ? void 0 : _c2.h24) == null ? void 0 : _d2.buys) ?? 0} / ${((_f2 = (_e2 = data == null ? void 0 : data.txns) == null ? void 0 : _e2.h24) == null ? void 0 : _f2.sells) ?? 0}`,
      accent: "cyan"
    }
  ];
  const change1h = ((_g2 = data == null ? void 0 : data.priceChange) == null ? void 0 : _g2.h1) ?? 0;
  const change6h = ((_h2 = data == null ? void 0 : data.priceChange) == null ? void 0 : _h2.h6) ?? 0;
  const change24h = ((_i2 = data == null ? void 0 : data.priceChange) == null ? void 0 : _i2.h24) ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "tokenomics",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono neon-green text-uppercase-tight tracking-widest mb-3", children: "LIVE DATA — UPDATES EVERY 5 SECONDS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl sm:text-5xl font-display font-black text-uppercase-tight text-foreground", children: "TOKENOMICS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-24 h-1 mx-auto mt-4",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { ...stat }, stat.label))
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 text-uppercase-tight mb-4", children: "PRICE CHANGE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-foreground/40 mb-1", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `text-xl font-mono font-bold ${item.value >= 0 ? "text-green-400" : "text-red-400"}`,
                    children: isLoading ? "..." : `${item.value >= 0 ? "+" : ""}${item.value.toFixed(2)}%`
                  }
                )
              ] }, item.label)) })
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-foreground/30 font-mono", children: [
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(LoreSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TokenomicsSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DexChartSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HowToBuySection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GallerySection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CommunitySection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FaqsSection, {})
  ] });
}
